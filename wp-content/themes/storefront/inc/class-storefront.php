...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			 ...
			 * Styles
			 */
			wp_enqueue_style( 'storefront-style', get_template_directory_uri() . '/assets/css/reset.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-awesome', get_template_directory_uri() . '/assets/css/font-awesome.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-mCustomScrollbar', get_template_directory_uri() . '/assets/css/jquery.mCustomScrollbar.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-custom-scroll', get_template_directory_uri() . '/assets/css/custom-scroll-menu.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-font-icon', get_template_directory_uri() . '/assets/css/font-icon.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-owl-carousel', get_template_directory_uri() . '/assets/css/owl.carousel.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-owl-theme', get_template_directory_uri() . '/assets/css/owl.theme.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-masterpage', get_template_directory_uri() . '/assets/css/masterpage.css', '', $storefront_version );
      wp_enqueue_style( 'storefront-style-header', get_template_directory_uri() . '/assets/css/flexslider.css', '', $storefront_version );
//      wp_enqueue_style( 'storefront-style-footer', get_template_directory_uri() . '/assets/css/footer.css', '', $storefront_version );
			 ...
			 * Scripts
			 */
			wp_enqueue_script( 'storefront-jquery-mCustomScrollbar', get_template_directory_uri() . '/assets/js/jquery.mCustomScrollbar.js', array( 'jquery' ), '20120206', true );
      wp_enqueue_script( 'storefront-custom-tpv', get_template_directory_uri() . '/assets/js/custom-tpv.js', array( 'jquery' ), '20120206', true );
      wp_enqueue_script( 'storefront-owl-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.js', array( 'jquery' ), '20120206', true );
			wp_enqueue_script( 'storefront-jquery-flexslider', get_template_directory_uri() . '/assets/js/jquery.flexslider.js', array(), '20130115', true );
